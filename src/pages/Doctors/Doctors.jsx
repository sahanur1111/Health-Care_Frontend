    ...
    <>
      <section className="bg-[#fff9ea] h-auto py-10">
        <div className="container text-center">
          <h2 className="flex items-center justify-center text-3xl leading-tight text-headingColor font-extrabold md:text-5xl md:leading-tight animate-bounce space-x-4">
            <span className="mr-2 animate-ping">
              <FcSearch />
            </span>
            Find a Doctor
          </h2>
          ...
          >
            ...
            <button
              className="btn mt-0 rounded-[0x] rounded-r-md flex items-center"
