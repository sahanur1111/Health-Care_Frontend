...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5 shadow-lg shadow-primaryColor/50 rounded-lg bg-white hover:shadow-2xl hover:shadow-primaryColor/90 transition-shadow duration-300 cursor-pointer">
      <div>
